...
- **Research-ready** — Zenodo DOI, ORCID attribution, deterministic output, and 137 unit tests
...
- **Tested**: 137 unit tests covering converters, harmonies, analysis, CLI, and all output formats
