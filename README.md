...
- **Research-ready** — Zenodo DOI, ORCID attribution, deterministic output, and 124 unit tests
...
- **Tested**: 124 unit tests covering converters, harmonies, analysis, CLI, and all output formats
