...
- **Research-ready** — Zenodo DOI, ORCID attribution, deterministic output, and 121 unit tests
...
- **Tested**: 121 unit tests covering converters, harmonies, analysis, CLI, and all output formats
